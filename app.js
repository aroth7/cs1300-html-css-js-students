...
const updatePage = async () => {
  ...
  const sugaryFruit = fruitsArray.filter(fruit => {return fruit.nutritions.sugar > 15;})
  const sugaryFruitNames = sugaryFruit.map(fruit => {return fruit.name;})
  console.log(sugaryFruit);

  // TODO: Create a new HTML element to display your data
  const fruitsElement = document.createElement('div');
  fruitsElement.innerHTML = "The fruits with sugar > 15 are: " + sugaryFruitNames.join(", ")


  // TODO: Append your new element to the page
  gallery.append(fruitsElement);
...
const exampleAddElement = () => {
  ...
  newElement.innerHTML = "The fruits with sugar > 15 are: " + sugaryFruitNames.join(", ");
